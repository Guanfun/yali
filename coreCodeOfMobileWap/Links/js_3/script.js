/******广东鸭梨***H5开发*******/ !(function ($) {
    ...
    $('.menu_open').bind('click', function (e) {
        if ($('#container').hasClass('pull') == false) {
            if (dd == 0) {
                $('#container,#menu,#header').addClass('push');
                dd = 1;
                ...
                $('#container,#menu,#header').removeClass('push');
                dd = 0
            }
        }
    });
    $('.nav_open').bind('click', function (e) {
        if ($('#container').hasClass('push') == false) {
            if (dd == 0) {
                $('#container,#nav,#header').addClass('pull');
                dd = 1;
                $(window).bind('touchmove', function (e) {
                    e.preventDefault();
                    e.stopImmediatePropagation()
                ...
                $('#container,#nav,#header').removeClass('pull');
                dd = 0;
    ...
    $('a').click(function () {
        var _this = $(this);
        if (_this.parent().hasClass('menu_back')) {} else if (_this.parent().hasClass('menu_back')) {
    ...
    var TouchSlide = function (a) {
        ...
        "leftLoop" == i && (P += 2, m.appendChild(m.children[0].cloneNode(!0)), m.insertBefore(m.children[n - 1].cloneNode(!
            0), m.children[0])), N = e(m, '<div class="tempWrap" style="overflow:hidden; position:relative;"></div>'),
        ...
        var W = function (a, b, c) {
            c = c ? c.style : m.style, c.webkitTransitionDuration = c.MozTransitionDuration = c.msTransitionDuration =
                c.OTransitionDuration = c.transitionDuration = b + "ms", c.webkitTransform = "translate(" + a + "px,0)" +
                "translateZ(0)", c.msTransform = c.MozTransform = c.OTransform = "translateX(" + a + "px)"
        }, X = function (a) {
                switch (i) {
                case "left":
