...
var refresher = {
	...
	onRelease: function(pullDownEl, pullUpEl) {
		if (pullDownEl.className.match('loading_refresh')) {
			pullDownEl.classList.toggle("loading_refresh");
			pullDownEl.querySelector('.pullDownLabel').innerHTML = refresher.info.pullDownLable;
			pullDownEl.querySelector('.loader').style.display = "none"
			pullDownEl.style.lineHeight = pullDownEl.offsetHeight + "px";
		}
		if (pullUpEl.className.match('loading_refresh')) {
			pullUpEl.classList.toggle("loading_refresh");
			pullUpEl.querySelector('.pullUpLabel').innerHTML = refresher.info.pullUpLable;
	...
	onPulling: function(pullDownEl, pullDownAction, pullUpEl, pullUpAction) {
		if (pullDownEl.className.match('flip') /*&&!pullUpEl.className.match('loading_refresh')*/ ) {
			pullDownEl.classList.add("loading_refresh");
			pullDownEl.classList.remove("flip");
		...
		if (pullUpEl.className.match('flip') /*&&!pullDownEl.className.match('loading_refresh')*/ ) {
			pullUpEl.classList.add("loading_refresh");
